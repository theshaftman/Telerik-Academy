//-----------------------------------------------------------------------
// <copyright file="StringExtensions.cs" company="TelerikAcademy.com">
...
namespace Telerik.ILS.Common
{
    ...
    {
        /// <summary>
        /// Hashes the given input into MD5.
        /// </summary>
        ...
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the input string converted to short.</returns>
        ...
        /// <summary>
        /// Converts the given input string to long.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the converted long value.</returns>
        ...
        /// <summary>
        /// Converts the given input string to date time.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the converted date time.</returns>
        ...
        /// <summary>
        /// Converts the cyrillic letters to latin in a given string input.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the input with changed letters type.</returns>
        ...
        /// <summary>
        /// Converts the latin letters to cyrillic ones in the given string input.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the converted letters to cyrillic type.</returns>
        ...
        /// <summary>
        /// Validates the given input string for user name.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the valid string.</returns>
        ...
        /// <summary>
        /// Validates the given input string for a file.
        /// </summary>
        /// <param name="input">Input string.</param>
        /// <returns>Returns the valid string.</returns>
        ...
        /// </summary>
        /// <param name="fileName">Input file name string.</param>
        /// <returns>Returns the last extension in a lowercase.</returns>
        ...
        /// <summary>
        /// Gets the content type of the given input string file extension.
        /// </summary>
        /// <param name="fileExtension">Input file extension string.</param>
        /// <returns>Returns the content type of the input file extension string.</returns>
